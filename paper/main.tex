...
\newcommand{\Hamid}[2]{\color{brickred} Hamid: #1\\ 
                \color{brickred} ----------------------------------- \\
                \color{black} #2\\ 
                \color{brickred} ----------------------------------- 
                \color{black}}
...
\begin{flushleft}
{\Large
\textbf\newline{Imbalanced multi-class classification: Model parameter report from the Reproducibility perspective} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
